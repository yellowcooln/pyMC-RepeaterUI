...
export const navigationItems: NavItemConfig[] = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        id: 'rf-health-correlation',
        label: 'RF Health Correlation',
        icon: BarChart2,
        route: '/rf-health-correlation',
      },
        ...
        children: [
          {
            ...
            children: [
              ...
              {
                id: 'config-radio-hardware',
                label: 'Radio Hardware',
                icon: Antenna,
                route: '/configuration',
                params: { tab: 'radio-hardware' },
                activeOn: ['/configuration'],
              },
              {
                id: 'config-repeater',
          ...
          },
          {
            ...
            children: [
              ...
              },
              {
                ...
                icon: Globe,
                route: '/configuration',
                params: { tab: 'transport' },
                activeOn: ['/configuration'],
              },
              {
                id: 'config-api-tokens',
                label: 'API Tokens',
                icon: KeyRound,
                route: '/configuration',
                params: { tab: 'api-tokens' },
                activeOn: ['/configuration'],
              },
              {
                id: 'config-web',
              ...
              {
                id: 'config-policy-engine',
                label: 'Policies',
                icon: Scale,
                route: '/configuration',
                params: { tab: 'policy-engine' },
                activeOn: ['/configuration'],
              },
            ],
          },
